...
\label{Result}
Assume the number of expected photons $N$ on PMT obeys Poisson distribution $\pi(\mu_N)$. Energy $E$ of Event is proportional to $N=k\eta E$, in which $k$ is a factor relate to light yield and light transportation. The photon detection efficiency of PMT is $\eta$ and the single PE charge distribution is Gaussian distribution $G(\mu_C,\sigma_C^2)$. The output charge distribution $C$ is a hierachical model and the expectation and variance are
\begin{align}
    E[C]&=\mu_N\mu_C\\
