...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\LF\textwidth]{triggerwave.pdf}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{\SF\textwidth}
        \includegraphics[width=\textwidth]{triggercharge.pdf}
        \caption{}%PM
    ...
    \begin{subfigure}[b]{\SF\textwidth}
        ...
        \includegraphics[width=\textwidth]{gainres.pdf}
        \caption{}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\MF\textwidth]{MCPelectron.pdf}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[t]{\SF\textwidth}
        \includegraphics[width=\textwidth]{triggerDoublePulse.pdf}
        \caption{}%PM
        \label{fig:triggerTT2pulse}
    \end{subfigure}
    \begin{subfigure}[t]{\SF\textwidth}
        \includegraphics[width=\textwidth]{triggerDelayedPulse.pdf}
        \caption{}%PM
...
\begin{figure}[!htbp]
    \centering
    \begin{subfigure}[t]{\SF\textwidth}
        \includegraphics[width=\textwidth]{triggerTTSLog.pdf}
        \caption{}%PM
        \label{fig:triggerTTSLog}
    \end{subfigure}
    \begin{subfigure}[t]{\SF\textwidth}
        \includegraphics[width=\textwidth]{triggerTTS2d.pdf}
        \caption{}%PM
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\LF\textwidth]{triggerAfterpulseSchema.pdf}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[t]{\LF\textwidth}
        \includegraphics[width=\textwidth]{triggerAfterpulse1d.pdf}
        \caption{}%PM
        \label{fig:afterpulse1d}
    \end{subfigure}
    \begin{subfigure}[t]{\LF\textwidth}
        \includegraphics[width=\textwidth]{triggerAfterpulse2d.pdf}
        \caption{}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{triggerafterpulseCharge.pdf}
